test_that("ez_scatter function works", {
  ...
  assert_equal(my_plot1, correct_plot1)
  ...
  assert_equal(my_plot2, correct_plot2)
  ...
  assert_equal(my_plot3, correct_plot3)
  ...
  assert_equal(my_plot4, correct_plot4)
  ...
  assert_equal(my_plot5, correct_plot5)
  ...
  assert_equal(my_plot6, correct_plot6)
